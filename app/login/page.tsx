...
function Login() {
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    alert('Login with email: ' + loginData.email)
  }
  ...
  const handleSignupSubmit = (e: React.FormEvent) => {
    ...
    alert('Account created with email: ' + signupData.email)
    setIsSignUp(false)
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-purple-500 to-purple-900 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition flex items-center justify-center gap-2"
              >
